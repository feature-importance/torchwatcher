...
class NodeSelector:
    ...
    def __init__(
        ...
        Args:
            selector_function: The selector function of form
        "nodestate -> bool". Defaults to ``None``, which uses identity
        "x -> true".
        """
        # Selector function.
...
def matches_name(name: str) -> NodeSelector:
    ...
    Returns:
        A node selector which returns True if the name matches
    """
...
def matches_module_class(clz: Type[Module]) -> NodeSelector:
    ...
    Args:
        clz: the class to match

    Returns:
        A node selector which returns True if the class matches
    """
